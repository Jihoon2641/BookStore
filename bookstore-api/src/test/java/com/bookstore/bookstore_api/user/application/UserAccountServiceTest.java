...
// import
// com.bookstore.bookstore_api.user.application.port.out.UserAccountRepository;
// import
// com.bookstore.bookstore_api.user.application.service.UserAccountService;
...
// @DisplayName("회원가입 성공")
// void signUp_success() {
// SignUpCommand command = new SignUpCommand("test", "test@example.com",
// "Password1!");
// when(userAccountRepository.findByEmail(anyString())).thenReturn(null);
// when(userAccountRepository.save(any())).thenReturn(User.create(command.getName(),
...
// when(userAccountRepository.findByEmail(anyString())).thenReturn(User.create(command.getName(),
// command.getEmail(), command.getPassword()));
...
// when(userAccountRepository.findByEmail(anyString())).thenReturn(User.create("test",
// command.getEmail(), command.getPassword()));
