...
// userAccountMapper.findByEmail("hong@example.com");
...
// // when
// Optional<UserEntity> found =
// userAccountMapper.findByEmail("notfound@example.com");
...
// // then
// Optional<UserEntity> foundUser1 =
// userAccountMapper.findByEmail("kim@example.com");
// Optional<UserEntity> foundUser2 =
// userAccountMapper.findByEmail("lee@example.com");
